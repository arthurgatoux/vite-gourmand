    ...
    <div className="mx-auto max-w-5xl px-4 py-8">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <Card>
          ...
          <CardContent className="space-y-3">
            <p className="text-sm text-muted-foreground">
              Creer ou desactiver des comptes employe. La creation d&apos;un compte
              administrateur reste impossible depuis l&apos;application.
            </p>
            <Button asChild size="sm" variant="secondary" disabled>
              <span>Gerer les comptes employe (a venir)</span>
            </Button>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            <p className="text-sm text-muted-foreground">
              Nombre de commandes par menu, chiffre d&apos;affaires et comparatif
              graphique, alimentes par la base NoSQL dediee.
            </p>
            <Button asChild size="sm" variant="secondary" disabled>
