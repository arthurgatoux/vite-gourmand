...
export const metadata = {
  title: "Comptes employé - Vite Gourmand",
};
...
export default async function AdminEmployesPage() {
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-8">
      ...
      <h1 className="mt-1 font-heading text-3xl">Comptes employé</h1>
      <p className="mt-2 text-sm text-muted-foreground">
        La création d&apos;un compte administrateur reste impossible depuis l&apos;application.
      </p>
      <div className="mt-8">
        <CreerEmployeForm />
      </div>
